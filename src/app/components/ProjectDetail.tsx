...
const projectData = {
    "admin-ops-automation": {
        ...
        process: [
            ...
            },
            {
                phase: "Verify",
                description:
                    "신규 항목 추가 시 화면 반영 여부와 기존 선택 흐름을 검증",
            },
            {
                phase: "Stabilize",
                description:
    ...
    "onboarding-qa-system": {
        ...
        overview:
            "신규 입사자가 팀의 코드 스타일과 업무 방식을 빠르게 이해할 수 있도록 온보딩 과제를 운영했습니다. 기존에는 실무 지식과 협업 방식이 구두로 전달되는 경우가 많아 적응 과정에서 반복적인 질문과 안내가 발생했습니다.\n\n이를 개선하기 위해 사내 홈페이지 개발 과제와 코드 리뷰 프로세스를 도입하고, 과제 수행 → 리뷰 → 피드백 반영으로 이어지는 온보딩 과정을 구축했습니다. 신규 구성원은 실제 업무와 유사한 환경에서 학습할 수 있었고, 팀은 일관된 기준으로 온보딩을 진행할 수 있게 되었습니다.",
        challenge:
        ...
        process: [
            {
                ...
                description:
                    "팀에서 중요하게 보는 코드 컨벤션과 화면 구현 기준 정리",
            },
            {
                phase: "Design Task",
                description:
            ...
            },
            {
                phase: "Improve Fit",
                description:
                    "신규 입사자가 막히는 지점을 확인하고 안내 방식을 보완",
            },
            {
                phase: "Transfer Knowledge",
                description:
                    "반복되는 질문과 기준을 다음 온보딩에 활용할 수 있게 정리",
            },
        ],
        features: [
            {
        ...
        metrics: [],
        results: [
            "신규 입사자가 사내 개발 규칙과 기술 환경을 빠르게 이해할 수 있는 학습 환경 구축",
        ...
        process: [
            {
                phase: "Listen",
                description:
                    "미용 서비스 경험을 살려 예약 전 정보 부족 문제 확인",
            },
            {
                phase: "Structure",
                description:
                    "고객이 입력해야 할 정보와 매장이 확인해야 할 정보를 분리",
            },
            {
                phase: "Build MVP",
                description:
    ...
    "service-flow-qa": {
        ...
        process: [
            ...
            },
            {
                phase: "Report Gap",
                description:
                    "요구사항과 실제 화면 사이의 차이를 재현 조건과 함께 공유",
            },
            {
                phase: "Regression Review",
                description:
                    "기능 추가 후 기존 화면 흐름이 깨지지 않는지 재확인",
            },
        ],
        features: [
            {
                    ...
                    <section className="px-6 md:px-8 mb-16 md:mb-24">
                        <div className="max-w-6xl mx-auto">
                            ...
                            <p className="mt-4 md:mt-5 text-sm md:text-base text-neutral-500 leading-[1.8]">
                                WebP 변환 및 이미지 최적화를 통해 이미지 용량을
                                13MB에서 1.4MB로 줄이고 Lighthouse 성능 점수를
                        ...
                        >
                            <div className="flex-1 min-w-0">
                                ...
                                <h2 className="text-xl md:text-3xl lg:text-4xl tracking-tighter group-hover:translate-x-4 transition-transform">
                                    {
                                        projectData[
                                            project.nextProject as keyof typeof projectData
                                        ].title
                                    }
                                </h2>
                            </div>

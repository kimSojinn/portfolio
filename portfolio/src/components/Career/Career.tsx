          ...
          experiences={[
            {
              description: (
                <>
                  ...
                  소프트웨어 지적재산권 유통 및 관리 플랫폼 Myso 개발
                </>
              ),
              subDescription: [
                <>
                  - Tailwind CSS 사용으로 인한 클래스 네이밍 난잡화 및 유지보수
                  이슈를 해결하기 위해,
                  <br />
                  컴포넌트 단위 스타일링이 가능한 CSS Module (.module.scss) 기반
                  구조를 도입하여 <strong>코드 가독성과 재사용성을 향상</strong>
                </>,
                <>
            ...
            },
            {
              ...
              subDescription: [
                <>
                  - am5chart 라이브러리를 활용해 데이터 시각화 및 차트 모듈 개발
                </>,
                <>
                  - 프로젝트 내 80여 개 드롭다운 항목을 수동 인덱싱하던 레거시
                  코드를 데이터 기반의 동적 렌더링 방식으로 리팩토링하여,
                  유지보수 과정의 번거로움을 줄이고 신규 항목 추가가 용이하도록
                  개선
                </>,
              ],
